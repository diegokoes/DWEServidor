...
<body>
    <div class="logout-container">
        ...
        <%
            // Retrieve the user information from the session if available
            String username = null;
            if (session != null) {
                username = (String) session.getAttribute("username"); // Adjust the attribute name as per your implementation
            }
            if (username != null) {
        %>
            <p>Hasta luego, <strong><%= username %></strong>!</p>
        <%
            }
        %>
