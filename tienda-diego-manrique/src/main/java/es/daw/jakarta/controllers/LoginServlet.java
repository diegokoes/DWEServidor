...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameOpt.isPresent()) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("    <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js' " +
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (USERNAME.equals(login) && PASSWORD.equals(pwd)) { // Validación exitosa
            ...
            // Generar página de error personalizada con Bootstrap
            try (PrintWriter out = response.getWriter()) {
                out.println("<!DOCTYPE html>");
                out.println("<html lang='es'>");
                out.println("<head>");
                ...
                out.println("        <a href='login.jsp' class='btn btn-primary'>Volver al Login</a>");
                out.println("    </div>");
                out.println("    <!-- Bootstrap JS -->");
                out.println("    <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js' " +
                            "integrity='sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+3q4RYv6jIW3L3Z8q4h+2L6U00Jv6' crossorigin='anonymous'></script>");
