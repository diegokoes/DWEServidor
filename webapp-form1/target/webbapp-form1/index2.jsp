  ...
  errores = (Map<String, String
    ...
    <html lang="en">
      ...
      <body>
        ...
        <%}%> // FORMA 2 <% // FORMA 2 if(errores!= null&& errores.size()>0){
        out.println("
        <h3>lista errores forma 2:</h3>
        <ul>
          ") for (String error: errores.values()){ out.println("
          <li>"+error+"</li>
          "); } out.println("
        </ul>
        ") } %>
        ...
        <form action="registro2" method="post">
          ...
          <div>
            ...
            out.println("<small style="color: red"
