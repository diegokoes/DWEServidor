...
public class ParamsFormServlet4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        logger.info("[ParamsFormServlet] username <" + username + ">");
         ...
         * Tu código dependerá de la interfaz (List) en lugar de la implementación
         * concreta (ArrayList).
         * Esto facilita cambiar la implementación a otra clase que implemente la
         * interfaz List
         * (como LinkedList, CopyOnWriteArrayList, etc.) sin necesidad de modificar
         * mucho el código.
         * Solo puedes utilizar los métodos definidos en la interfaz List.
         * Si necesitas acceder a métodos específicos de ArrayList, tendrías que hacer
         * un casting.
         */

        /*
         * ArrayList si necesitas acceso rápido por índice o si tienes pocas
         * modificaciones en la lista.
         * LinkedList si haces muchas inserciones o eliminaciones en el medio de la
         * lista o en los extremos, o si tu lista cambia de tamaño con mucha frecuencia.
         */
        // ArrayList<String> errores = new ArrayList<>();
        // List<String> errores2 = new ArrayList<>();
        // List<String> errores3 = new List<>(); // Error no puedo crear objetos de una
        // interface
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            out.println("       </ul>");
            out.println("       <p><a href=\"index4.jsp\">volver</a></p>");
